...
var app = angular.module('mainApp', ['ngRoute', 'ngResource']);  /*用angular.model是angular函数创建页面的一个程序入口，ngroute是singal page application.*/

app.factory('es', ['$q', '$http', ds.empService]);   /*$q是angular。gs里边的promise，所以引入$q,ds.emp.service是*/
